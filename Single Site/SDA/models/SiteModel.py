...
class SiteModel:
    ...
    def __init__(self) -> None:
        ...
        :return: none
        """
        self.area:AreaModel = AreaModel(None, None)
        self.building:BuildingModel = BuildingModel(None, None, None, None)
        self.floor:FloorModel = FloorModel(None, None, None, None, None, None)