...
""" Catalyst Center getReserveIPPool REST API Query Parameters """

class GetReserveIPPool:
    """
    get Reserve IP Pool API query parameters
    """
    def __init__(self,siteid:str) -> None:
        ...
        self.offset:str
        self.limit:str
        self.ignoreInheritedGroups:str
        self.poolUsage:str