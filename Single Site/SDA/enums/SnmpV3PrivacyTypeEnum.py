...
""" Catalyst Center API reserved values to represent SNMP V3 privacy types """
...
#
class SnmpV3PrivacyTypeEnum(str, Enum):
    """
    Enumeration to represent SNMP V3 privacy types
    """
    AES128:str = 'AES128'
    AES192:str = 'AES192'
    AES256:str = 'AES256'
