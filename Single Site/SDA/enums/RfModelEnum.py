...
""" Catalyst Center API reserved values to represent floor types """
...
#
class RfModelEnum(str, Enum):
    """
    Enumeration to represent floor types
    """
    CUBESANDWALLED:str = 'Cubes And Walled Offices'
    DRYWALLONLY:str = 'Drywall Office Only'
    INDOORHIGHCEILING:str = 'Indoor High Ceiling'
    OUTDOOROPENSPACE:str = 'Outdoor Open Space'
    #
