...
""" Catalyst Center API reserved values to represent NMP V3 SNMP modes """
...
#
class SnmpV3SnmpModeEnum(str, Enum):
    """
    Enumeration to represent SNMP V3 SNMP modes
    """
    AUTHPRIV:str = 'AUTHPRIV'
    AUTHNOPRIV:str = 'AUTHNOPRIV'
    NOAUTHNOPRIV:str = 'NOAUTHNOPRIV'
    #
