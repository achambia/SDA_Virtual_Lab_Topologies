...
""" Catalyst Center API reserved values to authentication profile names """
...
#
class AuthenticationProfileNameEnum(str, Enum):
    """
    Enumeration to represent authentication profile names
    """
    NONE:str = 'No Authentication'
    LOW:str = 'Low Impact'
    OPEN:str = 'Open Authentication'
    CLOSED:str = 'Closed Authentication'
    #
